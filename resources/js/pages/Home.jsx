...
const Home = () => {
    return <div className="container flex flex-col w-full h-screen justify-between p-os-8 items-center bg-yellow-100" >
        ...
        <div className="bg-yellow-200 w-5/12 m-3 h-4/6 p-os-20 text-os-title text-os-white font-bold  flex flex-col justify-between rounded-lg items-start border-os-2 border-os-black" >
        <span>
            Welcome page
        </span>
