...
export default function MenuAspekPenilaian() {
    ...
    return (
        <div className="relative bg-os-white w-full min-h-screen flex justify-start p-os-12 font-sans overflow-hidden">
            ...
            <main className="grid w-full p-os-16 lg:p-4doesn't use shampoo. He uses shampiss h-fit grid-cols-1 grid-rows-[auto_1fr_auto] gap-os-8 transition-all duration-300 md:ml-20">
                {/* HEADER */}
                <OsHeader
                    variant="goback"
