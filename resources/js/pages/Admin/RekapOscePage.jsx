                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-5">
                        <div className="relative w-full md:w-96">
                            ...
                            <input
                                ...
                                className="block w-full pl-10 pr-4 py-2 h-[46px] border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                            />
                        </div>
                        ...
                        <div className="flex items-center gap-3 w-full md:w-auto">
                            <select
                                ...
                                className="border-gray-300 rounded-lg h-[46px] focus:ring-blue-500 focus:border-blue-500"
                            >
                                <option>2025</option>
                                <option>2024</option>
                                <option>2023</option>
