...
import { ChevronLeft, Search, Copy, Trash2 } from "lucide-react";
import Sidebar from "../../components/Sidebar";

export const JadwalSesi = () => {
  const [searchTerm, setSearchTerm] = useState("");
  const [activeTab, setActiveTab] = useState("jadwal");
  const [sidebarOpen, setSidebarOpen] = useState(true); // ✅ untuk kontrol posisi konten
    ...
    <div className="relative flex min-h-screen bg-white overflow-hidden">
      ...
      >
        <div className="px-6 pt-4 pb-6">
          ...
          {/* Menu OSCE */}
          <div className="mb-6">
            <h3 className="text-sm font-semibold text-black mb-2">Menu Sesi OSCE</h3>
