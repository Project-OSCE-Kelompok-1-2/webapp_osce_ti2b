  ...
  return (
    <div className="bg-gray-100 w-full min-h-screen flex justify-center p-6 font-sans">
      ...
      <div className="grid w-full max-w-7xl h-fit grid-cols-1 grid-rows-[auto_1fr_auto] gap-2.5">
        ...
        {/* === HEADER (TETAP SAMA) === */}
        <header className="relative row-[1_/2] col-[1/_2] w-full flex flex-col items-start gap-5 bg-white p-4 rounded-xl shadow-sm border border-gray-900">
        ...
        <main className="relative row-[2_/3] col-[1/_2] w-full h-full flex flex-col items-start gap-3">
          <nav
        ...
        {/* === FOOTER (TETAP SAMA) === */}
        <footer className="relative row-[3_/4] col-[1/_2] w-full h-full flex flex-col items-center justify-end bg-white p-4 rounded-xl shadow-sm border border-gray-900">
