        ...
        <div className="flex h-[46px] items-center space-x-3 mb-5"> {/* Menambahkan margin bottom yang lebih jelas */}
            <div className="relative h-full w-full ">
                ...
                <input
                    ...
                    className="w-full rounded-lg py-2 pl-10 pr-4 h-full text-os-regular focus:outline-none border border-gray-300 focus:border-blue-500"
                />
            </div>
            <button
                onClick={onSearchClick}
                className="bg-blue-600 min-w-[120px] text-white h-full text-os-regular px-6 py-2 rounded-lg hover:bg-blue-700 transition duration-150"
            >
                Cari
            </button>
        </div>
