...
use App\Http\Controllers\AuthenticateApiController;
...
// === AKHIR GRUP ADMIN ===
Route::get("/docs/v1/api", [AuthenticateApiController::class, "show_api_docs"])->middleware(["auth", "authenticateApiDocs"]);
